        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_data_source_join_conditions_data_source_arithm_operators_ArithmeticOperatorId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_data_source_join_conditions_data_source_table_fields_TableFieldDataModelFieldId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_data_source_dataSources_data_source_classification_ClassificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_data_source_dataSource_fields_data_source_dataSources_DataSourceDataModelId",
                        column: x => x.DataSourceDataModelId,
                        principalTable: "data_source_dataSources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_data_source_dataSource_fields_data_source_function_FunctionId",
                        column: x => x.FunctionId,
                        principalTable: "data_source_function",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_data_source_dataSource_fields_data_source_table_fields_TableFieldId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_data_source_dataSource_tables_data_source_dataSources_DataSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_data_source_expression_terms_data_source_dataSource_tables_DataSourceTableId",
                        column: x => x.DataSourceTableId,
                        principalTable: "data_source_dataSource_tables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_data_source_expression_terms_data_source_dataSource_fields_FieldsDataSourceId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_data_source_expression_terms_data_source_operators_OperatorId",
                        column: x => x.OperatorId,
                        principalTable: "data_source_operators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_data_source_expression_terms_data_source_table_fields_TableFieldId",
                        column: x => x.TableFieldId,
                        principalTable: "data_source_table_fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "FirstTermId",
                unique: true,
                filter: "[FirstTermId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "SecondTermId",
                unique: true,
                filter: "[SecondTermId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_data_source_dataSources_data_source_expression_terms_HavingConditionId",
                table: "data_source_dataSources",
                column: "HavingConditionId",
                principalTable: "data_source_expression_terms",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_data_source_dataSources_data_source_expression_terms_WhereConditionId",
                table: "data_source_dataSources",
                column: "WhereConditionId",
                principalTable: "data_source_expression_terms",
                principalColumn: "Id",
